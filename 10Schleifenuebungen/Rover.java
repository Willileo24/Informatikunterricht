...
public class Rover extends Actor {
    ...
    public void aufgabe1() {
        this.setLocation(Greenfoot.getRandomNumber(16), Greenfoot.getRandomNumber(5) + 6);
    ...
    public void aufgabe2() {
        ...
        this.getWorld().addObject(new Huegel(), Greenfoot.getRandomNumber(16), this.getY() - 1);
